...
If a question can be answered by exploring the codebase, explore the codebase instead — so
that we discuss trade-offs and understand the rationale behind each key decision.
